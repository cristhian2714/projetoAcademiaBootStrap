...
class Inserir {
    public function inserirAluno(Conexao $conexao, $nome, $dtNascimento, $peso, $altura, $objetivo, $codigoPlano) {
        try {
    ...
    public function inserirTreino(Conexao $conexao, $codigoAluno, $codigoInstrutor, $objetivo, $frequencia, $duracao) {
        try {
            $conn = $conexao->conectar();
            $objetivo = mysqli_real_escape_string($conn, $objetivo);
    ...
    public function inserirExercicioTreino(Conexao $conexao, $codigoTreinamento, $codigoExercicio, $series, $repeticoes) {
        try {
            $conn = $conexao->conectar();
